...
export const useProject = () => {
  const projects = ref<Project[]>([
    ...
    },
    {
      ...
      title: "Pizza Queen",
      description:
        "Projeto de desenvolvimento de um sistema de delivery de pizzas",
      semester: "2º semestre",
      technologies: ["HTML", "CSS", "Flexbox", "Grid Layout"],
      link: "https://www.github.com/enzofagundz/pizza-queen",
      areas: ["Front-end", "Design", "UI/UX"],
      folder: "pizza-queen",
      quantityImages: 3,
    },
    {
      ...
      technologies: ["HTML", "CSS", "Flexbox", "Grid Layout", "JavaScript"],
      link: "https://www.github.com/enzofagundz/seance-ecommerce",
      areas: ["Front-end", "Design", "UI/UX", "Acessibilidade"],
    ...
    },
    {
      ...
      description:
        "Projeto de desenvolvimento de um banco de dados para gerenciamento de atletas de futebol",
    ...
    },
    {
      ...
      title: "Payzone",
      description:
        "Projeto de desenvolvimento de um sistema para a gestão de folha de pagamento",
      semester: "5º semestre",
      technologies: ["Laravel", "PHP", "MySQL", "Tailwind CSS"],
      link: "https://www.gitlab.com/enzofagundz/payzone",
      areas: ["Back-end", "Banco de Dados"],
      folder: "payzone",
      quantityImages: 6,
    },
    {
      ...
      description:
        "Projeto de instalação e configuração do GitLab para controle de versão e colaboração em projetos de software",
      semester: "6º semestre",
      link: null,
      technologies: ["GitLab", "Bitnami", "Oracle VM VirtualBox", "SSH"],
      areas: ["Controle de Versão", "DevOps", "Colaboração em Equipe"],
