        ...
        <aside class="flex flex-row justify-between w-full">
            ...
            <div class="flex flex-row space-x-4">
                <a href="https://www.linkedin.com/in/enzofagundz/"
                    ...
                    <Icon name="basil:linkedin-solid" class="w-4 h-4 text-base-100 dark:text-neutral-content" />
                </a>
                <a href="https://www.github.com/enzofagundz/"
                    class="w-8 h-8 bg-neutral rounded-full flex items-center justify-center" target="_blank"
                    rel="noopener noreferrer">
                    <Icon name="brandico:github" class="w-4 h-4 text-base-100 dark:text-neutral-content" />
                </a>
            </div>
        </aside>
    </footer>
