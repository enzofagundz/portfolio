<template>
    <div class="lg:w-1/2">
        ...
        <div class="container">
            <ul class="space-y-4">
                <li>
                    <a href="https://www.linkedin.com/in/enzofagundz/" class="flex items-center hover:bg-base-200 rounded-lg py-6 md:px-2">
                ...
                <li>
                    <a href="https://www.github.com/enzofagundz/" class="flex items-center hover:bg-base-200 rounded-lg py-6 md:px-2">
                        <div class="bg-neutral h-16 w-16 rounded-full flex items-center justify-center">
