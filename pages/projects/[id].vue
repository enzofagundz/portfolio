  ...
  <div>
    ...
    <div class="container space-y-10" v-else>
      <div class="container space-y-2">
        <h1
          class="text-2xl lg:text-4xl font-medium text-left text-base-content"
        >
          {{ project.title }}
        </h1>
      ...
      <div class="container" v-show="project.link">
        ...
        <a
          :href="project.link"
          target="_blank"
          class="btn btn-neutral dark:btn-primary"
        >
          Acesse aqui
      ...
      >
        <div
          ...
          v-for="n in project.quantityImages"
          :key="n"
        >
          <LazyNuxtImg
            :src="`/img/projects/${project.folder}/${n}.png`"
